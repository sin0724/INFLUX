      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-white rounded-lg p-4 border border-gray-200">
            <div className="text-xs text-gray-600 mb-1">전체 광고주</div>
            <div className="text-2xl font-bold text-gray-900">
              {formatNumber(stats.totalClients)}
            </div>
          </div>
          <div className="bg-white rounded-lg p-4 border border-gray-200">
            <div className="text-xs text-gray-600 mb-1">대기중 작업</div>
            <div className="text-2xl font-bold text-gray-900">
              {formatNumber(stats.pendingOrders)}
            </div>
          </div>
          <div className="bg-white rounded-lg p-4 border border-gray-200">
            <div className="text-xs text-gray-600 mb-1">진행중 작업</div>
            <div className="text-2xl font-bold text-gray-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <button
            onClick={() => router.push('/admin/review-orders')}
            className="bg-white border-2 border-gray-200 rounded-xl p-6 text-left hover:border-pink-400 hover:bg-pink-50 hover:shadow-md transition-all duration-200 group"
          >
            <div className="flex items-center gap-4 mb-3">
